import {LinkButton,sleep,subscribe,LinkToggleButton,HideButton,InsertIFrame,loadScriptAsync,getElement} from '../lib/koiosf_util.mjs';
...
async function InitMusic() {
  ...
  //    var widgetIframe = getElement(musicplayer),
